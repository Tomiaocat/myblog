...
<html>
<head>
    <title>Blogger a Blogging Category Flat Bootstrap Responsive Website Template | Single page :: 小贝壳网站模板</title>
	<#include "top.html"/>
</head>
<body>
        ...
        <div class="banner-section">
            ...
            <div class="single">
                ...
                <div class="b-bottom">
                    ...
                    <p class="sub">Lorem Ipsum is simply dummy text of the printing and typesetting industry.Lorem Ipsum
                        has been the industry's standard dummy text ever since,Lorem Ipsum is simply dummy text of the
                        printing and typesetting industry.Lorem Ipsum is simply dummy text of the printing and
                        typesetting industryLorem Ipsum has been the industry's standard dummy text ever since Lorem
                        Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
                    <p>On Aug 25 <a class="span_link" href="#"><span class="glyphicon glyphicon-comment"></span>0 </a><a
                            class="span_link" href="#"><span class="glyphicon glyphicon-eye-open"></span>56 </a></p>
            ...
            <div class="response">
                ...
                <div class="media response-info">
                    <div class="media-left response-text-left">
                        <a href="#">
                            <img class="media-object" src="/static/images/sin1.jpg" alt=""/>
                        </a>
                    ...
                    <div class="media-body response-text-right">
                        ...
                        <ul>
                            <li>Sep 21, 2015</li>
                            <li><a href="single.ftl">Reply</a></li>
                        </ul>
                        <div class="media response-info">
                            <div class="media-left response-text-left">
                                <a href="#">
                                    <img class="media-object" src="/static/images/sin2.jpg" alt=""/>
                                </a>
                                <h5><a href="#">Username</a></h5>
                            </div>
                            <div class="media-body response-text-right">
            ...
            <div class="general-news">
                <div class="general-inner">
                    <div class="general-text">
                        <a href="#"><img src="/static/images/gen1.jpg" class="img-responsive" alt=""></a>
                        ...
                        <p>On Jun 25 <a class="span_link" href="#"><span class="glyphicon glyphicon-comment"></span>0
                                ...
                                class="span_link" href="#"><span class="glyphicon glyphicon-circle-arrow-right"></span></a>
                        </p>
                    </div>
                    <div class="edit-pics">
                    ...
                    <div class="media">
                        ...
                        <div class="general-text two">
                            <a href="#"><img src="/static/images/gen3.jpg" class="img-responsive" alt=""></a>
                            <h5 class="top"><a href="#">Consetetur sadipscing elit</a></h5>
                            <p>Consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt labore dolore magna
                                aliquyam eratsed diam justo duo dolores rebum.</p>
                    ...
                    <div class="general-text two">
                        <a href="#"><img src="/static/images/gen2.jpg" class="img-responsive" alt=""></a>
                        <h5 class="top"><a href="#">Consetetur sadipscing elit</a></h5>
                        <p>Consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt labore dolore magna
                            aliquyam eratsed diam justo duo dolores rebum.</p>
                        <p>On Jun 27 <a class="span_link" href="#"><span class="glyphicon glyphicon-comment"></span>0
